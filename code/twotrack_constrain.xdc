...
## Pmod Header JA
## Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports audio_mclk_A]
   set_property IOSTANDARD LVCMOS33 [get_ports audio_mclk_A]
## Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports audio_lrck_A]
   set_property IOSTANDARD LVCMOS33 [get_ports audio_lrck_A]
## Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports audio_sck_A]
   set_property IOSTANDARD LVCMOS33 [get_ports audio_sck_A]
## Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports audio_sdin_A]
   set_property IOSTANDARD LVCMOS33 [get_ports audio_sdin_A]
## Sch name = JA7
...
## Pmod Header JB
## Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports audio_mclk_B]
    set_property IOSTANDARD LVCMOS33 [get_ports audio_mclk_B]
## Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports audio_lrck_B]
    set_property IOSTANDARD LVCMOS33 [get_ports audio_lrck_B]
## Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports audio_sck_B]
    set_property IOSTANDARD LVCMOS33 [get_ports audio_sck_B]
## Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports audio_sdin_B]
    set_property IOSTANDARD LVCMOS33 [get_ports audio_sdin_B]
## Sch name = JB7
